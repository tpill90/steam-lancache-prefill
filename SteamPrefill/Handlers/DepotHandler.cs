...
namespace SteamPrefill.Handlers
{
    ...
    public class DepotHandler
    {
        ...
        //TODO comment
        public async Task BuildLinkedDepotInfoAsync(List<DepotInfo> depotsToDownload, AppInfoShim app)
        {
            foreach (var depotInfo in depotsToDownload)
            {
                ...
                {
                    depotInfo.ManifestId = await GetLinkedAppManifestIdAsync(depotInfo, app);
                }
        ...
        // TODO document
        private async Task<ulong?> GetLinkedAppManifestIdAsync(DepotInfo depot, AppInfoShim app)
        {
            ...
            var parentAppInfo = await _appInfoHandler.GetAppInfoAsync(parentAppId);
