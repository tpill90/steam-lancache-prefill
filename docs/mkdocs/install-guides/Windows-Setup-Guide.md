...
2.  Download the latest version for Windows.  The filename should look like `{{app_name}}-X.Y.Z-win-x64.zip`.
...
Configuring your terminal to use Unicode will result in a much nicer experience with **{{app_name}}**, for much nicer looking UI output.
